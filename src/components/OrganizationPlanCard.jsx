...
function Card3() {
  return (
    <div className="flex flex-col gap-5 w-72.25 rounded-[10px] font-[Inter]  border border-[#FFE492] text-black px-5 py-5 bg-white md:w-118 md:px-11 md:py-20 lg:py-10 lg:px-11 lg:w-85.25 lg:h-174.25 xl:w-109.25 xl:h-163.5">
      ...
      <h1 className="font-semibold  text-[24px]">Organization</h1>

      <h2 className="text-[36px] lg:font-[Inter] lg:font-bold md:font-[Montserrat] md:font-normal">$49.99</h2>
      ...
      <div className="flex flex-col gap-7 leading-5 text-[16px] tracking-[-0.02em]">
        ...
        <div className="flex items-start gap-4">
         ...
         <button className="w-45 gap-0 flex items-center rounded-lg bg-white border border-[#FFE492] leading-7.5 px-10 py-4 font-[Inter] text-[18px] text-black md:mb-0 lg:mx-0 lg:mb-0 xl:mb-0 lg:w-45 lg:h-12.75">
        Get Started
      </button>
      </div>
