...
function Header() {
  return (
    <header className="flex items-center md:h-16.5 h-14 w-full px-4 py-4 justify-between bg-[#043873] lg:h-24 lg:px-8 2xl:px-55">
      <div className="md:w-47.75 md:h-5.6 w-33.5 h-6 gap-2 flex items-center ">
        {/*Logo*/}
        <img src={Logo} alt="logo" className="w-6 h-4 md:w-7.4 md:h-7.25" />
        <div className="text-white font-bold font-[Inter] text-[19px] md:text-[28px]">
          whitespace
        </div>
      </div>
